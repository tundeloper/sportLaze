const commentIcon = () => {
    return <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M9 9H15" stroke="#33363F" strokeWidth="2" stroke-linecap="round" strokeLinejoin="round" />
        <path d="M9 13H12" stroke="#33363F" strokeWidth="2" stroke-linecap="round" strokeLinejoin="round" />
    </svg>
}
