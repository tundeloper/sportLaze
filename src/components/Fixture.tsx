...
const Fixture = () => {
    return <div className="bg-gradient-to-b from-[#f1f1f1] via-[#f1f1f1] to-[rgba(71,58,133,0.45)] text-white mb-4 h-[50rem] dark:from-[black] dark:via-[black] dark:to-[black]" style={{ height: 'min-content', borderRadius: '1rem', overflow: 'hidden' }}>
        ...
        <div className="flex justify-center"><div className="flex justify-center items-center bg-white justify-center p-2 w-20 h-20" style={{ borderRadius: '100%', transform: 'translateY(-3rem)' }}><PremierLeagueLogo fill="#3E0F51"/></div></div>
