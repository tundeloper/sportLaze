    ...
    return <div className={`sliding-component gradient-bb relative pt-10 p-2 bg-[red] relative w-[20rem] ${profile ? 'no-profile' : 'profile'}`} style={{ position: 'fixed', left: '0', top: '0', zIndex: '3', borderTopRightRadius: '1rem', borderBottomRightRadius: '1rem' }}>
        ...
        <div className="border-b border-grey pb-10 mb-4">
            ...
            <div className="flex justify-around">
                <div className="flex flex-col items-center"><p className="text">Following</p> <p className="font-bold">{user.following}</p></div>
                <div className="flex flex-col items-center"><p>Followers</p> <p className="font-bold">{user.followers}</p></div>
            </div>
        </div>
        <div className="flex flex-col justify-center gap-4 pl-10 mb-4 mt-8">
        ...
        <div className="flex pl-10 mb-2 mt-2 text-white">
            <Button variant="text" sx={{textTransform: 'capitalize', color: 'white'}} className="self-start gap-4 text-white" onClick={() => {logout()}}>
                <LogoutIcon className="text-white"/>
                <span className="text-white">logout</span></Button>
        </div>
